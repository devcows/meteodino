json.array!(@meteo_data) do |meteo_datum|
  ...
  unless meteo_datum.attributes['temperature_in_avg'].blank?
    json.temperature_in_avg meteo_datum.attributes['temperature_in_avg']
  end

  unless meteo_datum.attributes['temperature_in_max'].blank?
    json.temperature_in_max meteo_datum.attributes['temperature_in_max']
  end

  unless meteo_datum.attributes['temperature_in_min'].blank?
    json.temperature_in_min meteo_datum.attributes['temperature_in_min']
  end
